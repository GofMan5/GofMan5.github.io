...
async function takeScreenshot() {
    try {
        ...
        function copyComputedStyles(source, target) {
            ...
            // Рекурсивно копируем стили для дочерних элементов
        ...
        // Ждем загрузки всех стилей и изображений
        ...
        const copyButton = loadingModal.querySelector('#copyButton');
        const imageLink = loadingModal.querySelector('#imageLink');
        ...
        showNotification('Скриншот успешно создан!', 'success');

        } catch (error) {
            console.error('Ошибка загрузки:', error);
            showNotification('Ошибка при загрузке скриншота', 'error');
